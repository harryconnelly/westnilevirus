# This is an example of developing a script locally with the West Nile Virus data to share on
# Kaggle
...
# Code is borrowed from this script:
...
traps = pd.read_csv('../input/train.csv')[['Date', 'Trap', 'Longitude',
                                           'Latitude', 'WnvPresent']]
